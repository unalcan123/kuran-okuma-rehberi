...
const List<ArabicLetter> kElTakisiOkunmayanWords = [
  ...
  ArabicLetter(order: 9, isolatedForm: 'اَلصَّابِرِينَ', audioAsset: '$_ders24AudioDir/09_kelime.mp3'),
  ...
  ArabicLetter(order: 13, isolatedForm: 'اَللَّيْلُ', audioAsset: '$_ders24AudioDir/13_kelime.mp3'),
