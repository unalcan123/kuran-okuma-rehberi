...
const List<ArabicLetter> kZamirHeUzatmaYokCezimliWords = [
  ...
  ArabicLetter(order: 2, isolatedForm: 'تَلْقَوْ هُ فَقَدْ', audioAsset: '$_ders30AudioDir/02_kelime.mp3'),
  ArabicLetter(order: 3, isolatedForm: 'فَلْيَصُمْهُ وَمَنْ', audioAsset: '$_ders30AudioDir/03_kelime.mp3'),
  ArabicLetter(order: 4, isolatedForm: 'مِنْهُ أَكْبَرُُ', audioAsset: '$_ders30AudioDir/04_kelime.mp3'),
