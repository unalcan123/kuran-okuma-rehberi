...
ArabicLetter(order: 8, isolatedForm: 'رَبُّنَا يَعْلَمُ', audioAsset: '$_ders35AudioDir/08_kelime.mp3'),
ArabicLetter(order: 9, isolatedForm: 'وَأَجْرٍ كَرِيمٍ', audioAsset: '$_ders35AudioDir/09_kelime.mp3'),
...
ArabicLetter(order: 15, isolatedForm: 'وَعِنَبًا وَقَضْبًا', audioAsset: '$_ders35AudioDir/15_kelime.mp3'),
ArabicLetter(order: 16, isolatedForm: 'أَفَلَا يَشْكُرُونَ', audioAsset: '$_ders35AudioDir/16_kelime.mp3'),
ArabicLetter(order: 17, isolatedForm: 'كَلَّا سَيَعْلَمُونَ', audioAsset: '$_ders35AudioDir/17_kelime.mp3'),
ArabicLetter(order: 18, isolatedForm: 'كِتَابٌ مَرْقُومٌ', audioAsset: '$_ders35AudioDir/18_kelime.mp3'),
ArabicLetter(order: 19, isolatedForm: 'وَتَشْهَدُ أَرْجُلُهُمْ', audioAsset: '$_ders35AudioDir/19_kelime.mp3'),
...
ArabicLetter(order: 22, isolatedForm: 'هُوَ يُبْدِئُ وَيُعِيدُ', audioAsset: '$_ders35AudioDir/22_kelime.mp3'),
ArabicLetter(order: 23, isolatedForm: 'لِنُخْرِجَ بِهِ حَبًّا', audioAsset: '$_ders35AudioDir/23_kelime.mp3'),
ArabicLetter(order: 24, isolatedForm: 'عَيْنًا يَشْرَبُ', audioAsset: '$_ders35AudioDir/24_kelime.mp3'),
ArabicLetter(order: 25, isolatedForm: 'فِرْعَوْنَ وَثَمُودَ', audioAsset: '$_ders35AudioDir/25_kelime.mp3'),
ArabicLetter(order: 26, isolatedForm: 'فَأَمَّا مَنْ طَغَى', audioAsset: '$_ders35AudioDir/26_kelime.mp3'),
ArabicLetter(order: 27, isolatedForm: 'عَلَيْهَا قُعُودٌ', audioAsset: '$_ders35AudioDir/27_kelime.mp3'),
];
