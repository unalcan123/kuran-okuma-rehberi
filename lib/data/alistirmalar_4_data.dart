...
const List<ArabicLetter> kAlistirmalar4Words = [
  ...
  ArabicLetter(order: 2, isolatedForm: 'وَالْقُرْآنِ لْحَكِيمِ', audioAsset: '$_ders37AudioDir/02_kelime.mp3'),
  ArabicLetter(order: 3, isolatedForm: 'اِنَّكَ لَمِنَ الْمُرْسَلِينَ', audioAsset: '$_ders37AudioDir/03_kelime.mp3'),
  ArabicLetter(order: 4, isolatedForm: 'اَلَّزِى فَطَرَنِى', audioAsset: '$_ders37AudioDir/04_kelime.mp3'),
  ArabicLetter(order: 5, isolatedForm: 'كَالْعُرْجُونِ الْقَدِيمِ', audioAsset: '$_ders37AudioDir/05_kelime.mp3'),
  ArabicLetter(order: 6, isolatedForm: 'خَلَقَ اْلأَزَوَاجَ', audioAsset: '$_ders37AudioDir/06_kelime.mp3'),
  ArabicLetter(order: 7, isolatedForm: 'مِنَ اْلأَجْدَاثِ', audioAsset: '$_ders37AudioDir/07_kelime.mp3'),
  ...
  ArabicLetter(order: 12, isolatedForm: 'أَبْصَارُهَاخَاشِعَةٌ', audioAsset: '$_ders37AudioDir/12_kelime.mp3'),
